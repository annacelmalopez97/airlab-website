    ...
    <footer className="bg-charcoal border-t border-white/10">
      <div className="container-inner py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          {/* Navigation */}
          <div>
            <p className="font-ui text-xs font-medium uppercase tracking-widest text-teal mb-4">Navigation</p>
          ...
          {/* Social */}
          <div>
            <p className="font-ui text-xs font-medium uppercase tracking-widest text-teal mb-4">Connect</p>
            <div className="flex gap-4">
              {/* LinkedIn */}
              <a
                href="https://www.linkedin.com/company/airlab-singapore"
                target="_blank"
              ...
              {/* X / Twitter */}
              <a
                href="https://twitter.com/airlabsingapore"
                target="_blank"
                rel="noopener noreferrer"
                className="text-white/60 hover:text-teal transition-colors"
        ...
        <div className="mt-10 pt-6 border-t border-white/10 text-center text-white/40 text-xs font-ui">
